...
class FewShotBatchSampler(object):
    ...
    def __iter__(self):
        ...
        for it in range(self.iterations):
            ...
            ## EDIT: don't randomly pick class_batch, just use all classes,
            ## since all tasks have 2 or 3 classes.
            class_batch = self.classes
            index_batch = []
...
class TaskBatchSampler(object):
    ...
    def __init__(self, all_dataset_targets, batch_size, N_way, K_shot, include_query=False, shuffle=True):
        """
        Inputs:
            dataset_targets - PyTorch tensor of the labels of the data elements.
        ...
        super().__init__()
        self.batch_samplers = []
        for dataset_targets in all_dataset_targets:
            sampler = FewShotBatchSampler(dataset_targets, N_way, K_shot, include_query, shuffle)
            self.batch_samplers.append(sampler)
